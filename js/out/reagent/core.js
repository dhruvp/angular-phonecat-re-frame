...
var G__12353__delegate = function (type,props,child,children){
if(!(cljs.core.map_QMARK_.call(null,props))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"not","not",1044554643,null),cljs.core.list(new cljs.core.Symbol(null,"map?","map?",-1780568534,null),new cljs.core.Symbol(null,"props","props",2093813254,null)))))].join('')));
}
...
var G__12353 = function (type,props,child,var_args){
var children = null;
...
while (G__12354__i < G__12354__a.length) {G__12354__a[G__12354__i] = arguments[G__12354__i + 3]; ++G__12354__i;}
  children = new cljs.core.IndexedSeq(G__12354__a,0);
} 
return G__12353__delegate.call(this,type,props,child,children);};
G__12353.cljs$lang$maxFixedArity = 3;
G__12353.cljs$lang$applyTo = (function (arglist__12355){
var type = cljs.core.first(arglist__12355);
arglist__12355 = cljs.core.next(arglist__12355);
var props = cljs.core.first(arglist__12355);
arglist__12355 = cljs.core.next(arglist__12355);
var child = cljs.core.first(arglist__12355);
var children = cljs.core.rest(arglist__12355);
return G__12353__delegate(type,props,child,children);
});
...
return create_element__4.cljs$core$IFn$_invoke$arity$variadic(type,props,child, G__12356);
}
...
var _STAR_non_reactive_STAR_12359 = reagent.impl.component._STAR_non_reactive_STAR_;
...
}finally {reagent.impl.component._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_12359;
}});
...
var _STAR_non_reactive_STAR_12361 = reagent.impl.component._STAR_non_reactive_STAR_;
reagent.impl.component._STAR_non_reactive_STAR_ = true;

try{return (React["renderToStaticMarkup"])(reagent.core.as_element.call(null,component));
}finally {reagent.impl.component._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_12361;
}});
...
var G__12362__delegate = function (x,rest){
return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
var G__12362 = function (x,var_args){
var rest = null;
if (arguments.length > 1) {
var G__12363__i = 0, G__12363__a = new Array(arguments.length -  1);
while (G__12363__i < G__12363__a.length) {G__12363__a[G__12363__i] = arguments[G__12363__i + 1]; ++G__12363__i;}
  rest = new cljs.core.IndexedSeq(G__12363__a,0);
} 
return G__12362__delegate.call(this,x,rest);};
G__12362.cljs$lang$maxFixedArity = 1;
G__12362.cljs$lang$applyTo = (function (arglist__12364){
var x = cljs.core.first(arglist__12364);
var rest = cljs.core.rest(arglist__12364);
return G__12362__delegate(x,rest);
});
...
var G__12365 = null;
if (arguments.length > 1) {
var G__12366__i = 0, G__12366__a = new Array(arguments.length -  1);
while (G__12366__i < G__12366__a.length) {G__12366__a[G__12366__i] = arguments[G__12366__i + 1]; ++G__12366__i;}
G__12365 = new cljs.core.IndexedSeq(G__12366__a,0);
}
return atom__2.cljs$core$IFn$_invoke$arity$variadic(x, G__12365);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
wrap.cljs$lang$applyTo = (function (arglist__12368){
var value = cljs.core.first(arglist__12368);
arglist__12368 = cljs.core.next(arglist__12368);
var reset_fn = cljs.core.first(arglist__12368);
...
var args = null;
if (arguments.length > 1) {
var G__12369__i = 0, G__12369__a = new Array(arguments.length -  1);
while (G__12369__i < G__12369__a.length) {G__12369__a[G__12369__i] = arguments[G__12369__i + 1]; ++G__12369__i;}
  args = new cljs.core.IndexedSeq(G__12369__a,0);
} 
return partial__delegate.call(this,f,args);};
partial.cljs$lang$maxFixedArity = 1;
partial.cljs$lang$applyTo = (function (arglist__12370){
var f = cljs.core.first(arglist__12370);
var args = cljs.core.rest(arglist__12370);
