...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__3811__auto__,writer__3812__auto__,opt__3813__auto__){
return cljs.core._write.call(null,writer__3812__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12426 = o;
(G__12426[reagent.impl.template.cached_prop_name.call(null,k)] = convert_prop_value.call(null,v));
...
var old_12430 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_12430))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_12430)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__3212__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__12433 = jsprops;
(G__12433["defaultValue"] = value);

(G__12433["onChange"] = ((function (G__12433,v,value,on_change){
return (function (p1__12431_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12431_SHARP_);
});})(G__12433,v,value,on_change))
);
...
var vec__12435 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12435,(0),null);
var id = cljs.core.nth.call(null,vec__12435,(1),null);
var class$ = cljs.core.nth.call(null,vec__12435,(2),null);
...
var temp__4128__auto__ = (function (){var G__12437 = cljs.core.meta.call(null,v);
var G__12437__$1 = (((G__12437 == null))?null:reagent.impl.template.get_key.call(null,G__12437));
return G__12437__$1;
})();
if((temp__4128__auto__ == null)){
...
var jsprops = {"argv": v};
var G__12439_12440 = v;
var G__12439_12441__$1 = (((G__12439_12440 == null))?null:reagent.impl.template.key_from_vec.call(null,G__12439_12440));
var G__12439_12442__$2 = (((G__12439_12441__$1 == null))?null:(jsprops["key"] = G__12439_12441__$1));
...
var p = (function (){var temp__4128__auto__ = (function (){var G__12445 = cljs.core.meta.call(null,argv);
var G__12445__$1 = (((G__12445 == null))?null:reagent.impl.template.get_key.call(null,G__12445));
return G__12445__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__12446 = (((jsprops == null))?{}:jsprops);
(G__12446["key"] = key);
...
var n__4111__auto___12447 = a.length;
var i_12448 = (0);
while(true){
if((i_12448 < n__4111__auto___12447)){
(a[i_12448] = reagent.impl.template.as_element.call(null,(a[i_12448])));
...
var a = cljs.core.into_array.call(null,s);
var n__4111__auto___12450 = a.length;
var i_12451 = (0);
while(true){
if((i_12451 < n__4111__auto___12450)){
var val_12452 = (a[i_12451]);
if((cljs.core.vector_QMARK_.call(null,val_12452)) && ((reagent.impl.template.key_from_vec.call(null,val_12452) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12451] = reagent.impl.template.as_element.call(null,val_12452));
...
var G__12455 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12455) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12455){
